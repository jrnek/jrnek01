...
class CCMycontroller extends CObject implements IController {
  ...
  public function Index() {
	...
	$this->views->AddInclude(__DIR__ . '/sidebar.tpl.php', array('links' => $this->GetSidebarMenu()), 'secondary');
  }
  ...
  public function Guestbook() {
    ...
    if($status === false) {
      ...
      $this->RedirectTo('mycontroller/guestbook');
    } else if($status === true) {
      $this->RedirectTo('mycontroller/guestbook');
    }
  ...
  private function GetSidebarMenu() {
	$rc = new ReflectionClass('CCMycontroller');
	return $rc->getMethods(ReflectionMethod::IS_PUBLIC);
  }
